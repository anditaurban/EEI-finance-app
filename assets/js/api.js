const isLocalhost = ['localhost', '127.0.0.1', 'finance.energieei.co.id', 'eei-finance-app.vercel.app'].includes(window.location.hostname);
const mode = isLocalhost ? 'development' : 'production';
const baseUrl = mode === 'production'
  ? 'https://apieei.katib.cloud'  //production
  : 'https://devapieei.katib.cloud';   //development
